import asyncpg
import datetime
from app.models.preguntas_respuestas import AsignacionEncuestaCreate, EncuestaResponse, AsignacionEncuestaResponse, RespuestaItem


class dashboardEstudiantesRepository:
    def __init__(self, conn: asyncpg.Connection) -> None:
        super().__init__(conn, dashboardEstudiantesRepository)
    ...
    async def get_assigned_surveys(self, estudiante_id: int) -> list[dict]:
        rows = await self.conn.fetch(
            """
            SELECT 
